...
class Workout < ApplicationRecord
  ...
  def show_hash_blocks
...

    {
      ...
      cn_blocks_duration_text: cn_blocks_duration_text.presence || "",
      ...
      cn_block_a_format: cn_block_a_format.presence || "",
      block_b_format: block_b_format.presence || "",
      cn_block_b_format: cn_block_b_format.presence || "",
      block_c_format: block_c_format.presence || "",
      cn_block_c_format: cn_block_c_format.presence || "",
      block_a_title: block_a_title.presence || "",
      cn_block_a_title: cn_block_a_title.presence || "",
      block_b_title: block_b_title.presence || "",
      cn_block_b_title: cn_block_b_title.presence || "",
      block_c_title: block_c_title.presence || "",
      cn_block_c_title: cn_block_c_title.presence || "",
      block_a_duration_format: block_a_duration_format.presence || "",
      cn_block_a_duration_format: cn_block_a_duration_format.presence || "",
      block_b_duration_format: block_b_duration_format.presence || "",
      cn_block_b_duration_format: cn_block_b_duration_format.presence || "",
      block_c_duration_format: block_c_duration_format.presence || "",
      cn_block_c_duration_format: cn_block_c_duration_format.presence || "",
      block_a_reps_text: block_a_reps_text.presence || "",
      cn_block_a_reps_text: cn_block_a_reps_text.presence || "",
      block_b_reps_text: block_b_reps_text.presence || "",
      cn_block_b_reps_text: cn_block_b_reps_text.presence || "",
      block_c_reps_text: block_c_reps_text.presence || "",
      cn_block_c_reps_text: cn_block_c_reps_text.presence || "",
      warmup_duration_format: warmup_duration_format.presence || "",
      cn_warmup_duration_format: cn_warmup_duration_format.presence || "",
      finisher_title: finisher_title.presence || "",
      cn_finisher_title: cn_finisher_title.presence || "",
      finisher_format: finisher_format.presence || "",
      cn_finisher_format: cn_finisher_format.presence || "",
      finisher_duration_format: finisher_duration_format.presence || "",
      cn_finisher_duration_format: cn_finisher_duration_format.presence || "",
      finisher_reps_text: finisher_reps_text.presence || "",
      cn_finisher_reps_text: cn_finisher_reps_text.presence || "",
